...
public class User{
	...
	public void saveProfpic(){
		...
		try{
			...
			con = DriverManager.getConnection("jdbc:mysql://localhost:3306/ecomdb?user=root&password=12345");
	...
	public boolean saveUser(){
		...
		try{
			...
			String query = "insert into users (username,email,password,activation_code,status_id) value (?,?,?,?,?)";
